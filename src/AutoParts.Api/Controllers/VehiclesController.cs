...
public sealed class VehiclesController(IVehicleService service) : ControllerBase
{
    ...
    [HttpGet("resolve-chassis")] public async Task<ActionResult<VehicleChassisLookupResponse>> ResolveChassis([FromQuery] string value, CancellationToken ct) => Ok(await service.ResolveByChassisAsync(value, ct));
